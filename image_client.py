...
des_encoded = []
for char in des_key:
    des_encoded.append(str(encrypt(public, ord(char))))
    mySocket.sendto(struct.pack('i', des_encoded),(SERVER_IP,PORT_NUMBER))
# des_encoded=['2313','3231','532515','542515','5135151','31413','15315','14314']
[mySocket.sendto(code.encode(), (SERVER_IP, PORT_NUMBER)) for code in des_encoded]  # do not change [sends message through socket]
